    ...
    if(!count($errors)){
        ...
        $stmt->bind_param('ss', $code, $email);
         ...
         if($stmt->execute()){
            ...
            $message = "Hi! You requested an account verification. You need to click here to <a href='".URLROOT."/process/p_account_verify.php?code=$code'>activate your account.</a>";
