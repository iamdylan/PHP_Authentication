...
if(isset($_POST['change_password'])){
    ...
    $user = $_SESSION['user'];
     ...
     if(strlen($old_password)>20 || strlen($old_password)<5){
         $errors['old_password_err'] = 'Old Password min limit is 5 & max limit is 20 characters';
     }elseif(!password_verify($old_password, $user->password)){
         $errors['old_password_err'] = 'Old password incorrect please enter a valid password';
     }
     //password 
